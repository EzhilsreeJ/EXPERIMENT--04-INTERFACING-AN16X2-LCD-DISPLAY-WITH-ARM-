...
#include"lcd.h"
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
  	  ...
  	  Lcd_cursor(&lcd, 0,0);
  	  Lcd_string(&lcd, "Name:EZHIL SREE J");
  	  Lcd_cursor(&lcd ,1,0);
  	  Lcd_string(&lcd, "212223230056");
```


## Output screen shots of proteus  :
 ![image](https://github.com/user-attachments/assets/bf3a0c02-b4e9-4cf8-90d1-a9241b74da4a)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/375f9acc-3737-4fd0-8c09-f296627403fa)
